...
- 게시글이 없을 경우 게시물이 없음을 나타내는 화면을 따로 구성해 나오도록 했습니다.
<br><br><br>
...
- 검색 시 DB에 데이터를 저장하고 구독해 실시간으로 유저들이 가장 많이 검색한 상위 검색어들을 표시하도록 했습니다.
<br><br><br>

## 아쉬웠던 점

 이 전 리액트로 프로젝트를 진행하며 SEO 문제가 있고 이를 NextJS를 사용해 서버사이드 랜더링을 통해 해결할 수 있음을 알게되고 이를 적용하기 위해 NextJs로 프로젝트를 진행하게 되었습니다.<br>
getServerSideprops라는 함수를 사용하여 미리 데이터를 가져와 초기 랜더링 시에 html에도 모든 데이터가 나타나게 되었고 SEO문제가 해결 한 줄 알았습니다.<br>
